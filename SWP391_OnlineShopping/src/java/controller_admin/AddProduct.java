...
public class AddProduct extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DAOSize sdao = new DAOSize();
            List<Size> listSize = sdao.getAllSize();
            DAOColor cdao = new DAOColor();
            List<Color> listColor = cdao.getAllColor();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String id = dp.getLatestProductID();
            for (String i : items.split("/")) {
                String[] s = i.split("-");
                String sizeId = s[0];
                String colorId = s[1];
                String quantity = s[2];
                String imageDetail = s[3];
                dp.insertDataProductDetail(sizeId, colorId, quantity,id);
                dp.insertDataProductImage(colorId, id, imageDetail);
            }
