    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cart.getItems().isEmpty()) {
                ...
                if (a == null) {
                    session.setAttribute("memoLink", "/SWP391_OnlineShopping/checkout");
...
// Lấy thông tin người dùng từ session
            ...
            if (a == null) {
                ...
                request.getSession().setAttribute("successMessage", "Vui lòng chọn phương thức thanh toán !");
                response.sendRedirect("/SWP391_OnlineShopping/cart/checkout.jsp");}
