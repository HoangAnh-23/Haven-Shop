                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <div class="col-md-6 form-group">
                                    <h2></h2><label class="text-danger" style="font-weight: 600; font-size: 25px">Họ tên</label>
                                    <h6 class="mb-0"> ${i.fullname}</h6>                               
                                </div>

                                <div class="col-md-6 form-group">
                                    <label class="text-danger" style="font-weight: 600; font-size: 25px">Email</label>
                                    <h6 class="mb-0"> ${i.email}</h6>                               
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="text-danger" style="font-weight: 600; font-size: 25px">Số điện thoại</label>
                                    <h6 class="mb-0"> ${i.phone_number}</h6>                               
                                </div>
                                <div class="col-md-6 form-group">   
                                    <label class="text-danger" style="font-weight: 600; font-size: 25px">Địa chỉ giao hàng</label>
                                    <h6 class="mb-0"> ${i.address}</h6>                               
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <c:forEach items="${o.items}" var="i">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <p style="font-size: 19px"><fmt:formatNumber pattern="###,###" value="${i.product.getPrice() * i.quantity}"/>₫</p>
                                    </div>
                                </c:forEach>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <input style="margin-left: 20px" type="radio" name="payment" value="E-Wallet">
