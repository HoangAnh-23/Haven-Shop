        ...
        <div class="row px-xl-5" style="padding-top: 50px">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    <thead class="bg-secondary">
                        ...
                        <c:if test="${size>0}">
                            ...
                            <th style="font-size: 20px">Màu sắc - Kích cỡ</th>
                ...
                <tbody class="align-middle">
                    ...
                    <td class="align-middle">
                        <div class="input-group quantity mx-auto" style="width: 100px;">
                            <div class="input-group-btn">
                                <a style="color: BLACK"href="process?num=-1&productID=${i.product.productID}&sizeId=${i.size.sizeId}&colorId=${i.color.colorId}">-</a>
                    ...
                    <td style="font-size: 20px" class="align-middle">${i.color.colorName}-${i.size.size}</td>
                    <td style="font-size: 20px" class="align-middle"><fmt:formatNumber pattern="###,###" value="${i.product.getPrice() * ((100.0 - i.product.getDiscountSale()) / 100.0)}"/>₫</td>

                    <td style="font-size: 20px" class="align-middle"><fmt:formatNumber pattern="###,###" value="${(i.product.getPrice() * ((100.0 - i.product.getDiscountSale()) / 100.0)) * i.quantity}"/>₫</td>
                    ...
                    <div class="card-body">
                            <c:forEach items="${o.items}" var="i">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <h6 class="align-middle"><fmt:formatNumber pattern="###,###" value="${i.product.getPrice() * ((100.0 - i.product.getDiscountSale()) / 100.0)}"/>₫</h6>
                                </div>
                            </c:forEach>
                            <br/>
                            <div class="d-flex justify-content-between">
...
<c:if test="${size == 0}">
    <p style="text-align: center; font-size: 40px;">Cảm ơn bạn đã luôn đồng hành và tin tưởng chúng tôi!</p>

    <a href="/SWP391_OnlineShopping/home"><p style="text-align: center;font-size: 30px">Đi mua sắm nào !<img src="/SWP391_OnlineShopping/assets/img/go.png"width="40px" height="40px" alt="alt"/></p></a>
