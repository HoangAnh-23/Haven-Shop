...
<html lang="en">
    ...
    <body>
        ...
        <h2 style="text-align: center; margin-top: 40px ; font-size: 45px; font-family: fantasy">Best Seller - Hot Deal</h2>
    <c:set value="${requestScope.listP}" var="list" />

    <div class="row pb-3" style="width: auto;height: auto;text-align: center;margin-left: 30px">
                <c:forEach items="${list}" var="i">    
                    <div style="padding-left: 40px;margin-top: 30px;text-align: center;" class="col-lg-2 col-md-6 col-sm-12 pb-1">
                        <div class="card product-item border-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <a href="/SWP391_OnlineShopping/product/productdetail?productID=${i.getProductID()}&sizeID=${i.getSize()}&colorID=${i.getColor()}">
                                    <img class="img-fluid w-100" src="/SWP391_OnlineShopping/assets/imageproduct/${i.getImage()}" alt=""></a>
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3"><a style="color: black"href="/SWP391_OnlineShopping/product/productdetail?productID=${i.getProductID()}&sizeID=${i.getSize()}&colorID=${i.getColor()}">${i.getProductName()}</a></h6>
                                <div class="d-flex justify-content-center">
                                    <h6 style="color: red"><fmt:formatNumber pattern="###,###" value="${i.getPrice() * ((100.0 - i.getDiscountSale()) / 100.0)}"/>₫</h6><h6 class="text-muted ml-2"><del><fmt:formatNumber pattern="###,###" value="${i.price}"/>₫</del></h6>
                                </div>
                            </div>
