        ...
        <form name="a" action="" method="post">
            <div class="row px-xl-5" style="padding-top: 50px">       
                ...
                <div class="col-lg-6 pb-5">
                    ...
                    <div class="size-container">
                        ...
                        <c:forEach items="${requestScope.qsize}" var="i">
                            <button type="button" id="size-${i.sizeId}" 
                                    class="size-button" onclick="setSize('${i.sizeId}')">${i.size}</button>
                        </c:forEach>
                    </div>
                ...
                <div class="text-center w-100">
                    <h1>Size tham khảo</h1>
                    <img class="mx-auto"
                         src="https://songsongshop.vn/wp-content/uploads/2022/07/bang-size-ao-nu-quoc-te.jpg"
                         alt="alt" style="width: 50%;"/>
                </div>
            </div>
        </form>
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="nav nav-tabs justify-content-center border-secondary mb-4">
                    <a class="nav-item nav-link active" data-toggle="tab" href="#tab-pane-1">Feedback</a>
