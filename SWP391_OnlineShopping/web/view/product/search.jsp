...
<html lang="en">
    ...
    <body>
        ...
        <div class="nav-bar">
            ...
            <a style="color: black; font-size: 17px; font-weight: bold;" class="nav-link">Kết Quả Tìm kiếm Cho Từ  :${txtInput}</a>
        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                                <div class="card product-item border-0 mb-4">
                                    ...
                                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                        <h6 class="text-truncate mb-3"><a style="color: black"href="product/productdetail?productID=${p.productID}&sizeID=${p.getSize()}&colorID=${p.getColor()}">${p.productName}</a></h6>
                                        <div class="d-flex justify-content-center">
                                         
                                            <h6 style="color: red"><fmt:formatNumber pattern="#,###,###" value="${p.getPrice() * ((100.0 - p.getDiscountSale()) / 100.0)}"/>₫</h6>
                                            <h6 class="text-muted ml-2"><del><fmt:formatNumber pattern="###,###" value="${p.price}"/>₫</del></h6>
